package com.bbc_icontent.screens
{
	...
	public class ScreenKitchen04 extends Screen
	{
		
		private var sec:int;
		private var quizTime:ClockSkined;
		
		private var cl1:MovieClip,cl2:MovieClip, cr1:MovieClip,cr2:MovieClip;
		
		private var batcl1:MovieClip,batcl2:MovieClip,
		batcr1:MovieClip,batcr2:MovieClip;
		...
		public function ScreenKitchen04()
		{
			scoreMax = 2;
			sec = 60;
			...
			matchablesRight.push(cr1, cr2);
			
			dataArr.push(
				"Ilya ev †Zj e¨envi K‡i "+separetor+"cyi“lv‡½i AvKvi-AvK…wZ cwieZ©b Kiv hvqbv; G‡Z eis ¶wZ nIqvi m¤¢vebv _v‡K|", 
				"cyi“lv½ wb‡q †Zvgvi AviI wKQz Rvbvi _vK‡j "+separetor+"Wv³vi ev ¯^v¯’¨Kg©xi mv‡_ K_v ej‡e|");
			...
			scoreMessage = "Ilya ev †Zj e¨envi K‡i cyiælv‡½i AvKvi-AvK…wZ cwieZ©b Kiv hvqbv| G‡Z eis ¶wZ nIqvi m¤¢vebv _v‡K cyiælv½ wb‡q †Zvgvi AviI wKQz Rvbvi _vK‡j Wv³vi ev ¯^v¯’¨Kg©xi mv‡_ K_v ej‡e|";
		}
		...
		override public function resume():void
		{
			...
			TweenLite.to(batcl1, .5,{x:750, y:150, easing:Bounce.easeIn, onComplete:removeBats, onCompleteParams:[batcl1]});
			TweenLite.to(batcl2, .3,{x:750, y:150, easing:Bounce.easeIn, onComplete:removeBats, onCompleteParams:[batcl2]});
			TweenLite.to(batcr1, .6,{x:750, y:150, easing:Bounce.easeIn, onComplete:removeBats, onCompleteParams:[batcr1]});
			TweenLite.to(batcr2, .2,{x:750, y:150, easing:Bounce.easeIn, onComplete:removeBats, onCompleteParams:[batcr2]});
		}
		private var remainingBat:int = 4;
		private function removeBats(_bat:MovieClip):void{
			if(_bat != null) removeChild(_bat);
			remainingBat--;
			if(remainingBat == 0){
